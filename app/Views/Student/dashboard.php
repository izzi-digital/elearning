  ...
  <div class="container">
    <div class="content-wrapper">
      ...
      <section class="features">
        ...
        <?php
        $mapelByClass = model('MapelModel')->getJoin()->where('id_kelas', Auth()['class_room'])->findAll();
        foreach ($mapelByClass as $item) : ?>
          <div class="feature-card glass">
            <div class="feature-icon">✨</div>
            <h3><?= $item['nama_mapel'] ?></h3>
            <p><?= $item['full_name'] ?></p>
            <a href="<?= base_url('MasukKBM/' . $item['id']) ?>" class="cta-button">Masuk</a>
          </div>
        <?php endforeach ?>
